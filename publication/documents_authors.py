...
class Dumper(object):
    ...
    def __init__(self, collection, issns=None, output_file=None):
        ...
        header.append("document author")
        header.append("document author institution")
        header.append("document author affiliation country")
        header.append("document author affiliation state")
        header.append("document author affiliation city")
