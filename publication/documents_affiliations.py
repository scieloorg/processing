...
class Dumper(object):
    ...
    def __init__(self, collection, issns=None, output_file=None):
        ...
        header.append("document affiliation instituition")
        header.append("document affiliation country")
        header.append("document affiliation country ISO 3166")
        header.append("document affiliation state")
        header.append("document affiliation city")
